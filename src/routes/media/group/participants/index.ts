...
class Controller implements MicroController {
    ...
    async GET(req: IncomingMessage, res: ServerResponse, ctx: handler_context) {
        ...
        return clinic_media_domain.get_clinic_media_access_group_participant({
            ...req.query as any,
    ...
    async POST(req: IncomingMessage, res: ServerResponse, ctx: handler_context) {
        ...
        return clinic_media_domain.add_clinic_media_access_group_participant({
            ...req.body as any,
            user_id: <string>userId
        })
    ...
    async DELETE(req: IncomingMessage, res: ServerResponse, ctx: handler_context) {
        ...
        return clinic_media_domain.remove_clinic_media_access_group_participant({
            ...req.body as any,
            user_id: <string>userId
        })
